...
public class TunerConstants {
    public final boolean IsMainChassis = false;
    public final boolean IsTestChassis = true;
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.19384765625);
